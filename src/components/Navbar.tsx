      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
        ...
        >
          ...
          <a
            ...
            className="hidden sm:flex items-center gap-2 bg-brand text-slate-950 px-6 py-2.5 rounded-full font-bold hover:bg-brand-hover transition-colors shadow-[0_0_20px_rgba(198,255,0,0.3)] hover:shadow-[0_0_30px_rgba(198,255,0,0.5)]"
          >
            {t('download', 'nav')}
          </a>
        </motion.div>
